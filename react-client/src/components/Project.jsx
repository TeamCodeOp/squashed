          ...
          <Item.Group>
            <Item style={{
              ...
              <Item.Content>
                ...
                <Item.Meta>by <Link to={`https://codeop28.herokuapp.com/users/${this.state.githubUser}` || `http://localhost:3000/users/${this.state.githubUser}`}>{this.state.githubUser}</Link></Item.Meta>
                <Item.Description>
